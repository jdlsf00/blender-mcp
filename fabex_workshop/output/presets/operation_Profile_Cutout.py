"""Generated operation preset for Profile_Cutout."""
...
operation.strategy = "CUTOUT"
operation.cutter_type = "ENDMILL"
operation.spindle_rpm = 10000
operation.feedrate = 0.800000
operation.plunge_feedrate = 0.220000
operation.stepover = 0.350000
operation.stepdown = 0.001250

if hasattr(operation, "skin"):
    operation.skin = 0.000200

print("Loaded operation preset: Profile_Cutout")
